...
const questions = [
  ...
  {
    category: "Comunidade Local",
    identifier: "communitdevelopment",
  ...
  {
    category: "Estrutura de Governança",
    identifier: "transparentdecision",
  ...
  {
    category: "Diversidade do Conselho",
    identifier: "boarddiversitypolicy",
  ...
  {
    category: "Gestão de impactos",
    identifier: "boardresponsability",
  ...
  {
    category: "Satisfação dos Stakeholders",
    identifier: "stakeholdersfeedback",
  ...
  },
  {
    ...
    required: true,
    identifier: "supplyend"
  },
];

export const createQuestions = async () => {
  const createdQuestions = await Promise.all(
    questions.map(async ({ name, category, description, required, identifier }) => {
